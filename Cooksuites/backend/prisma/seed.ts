...
async function main() {
  const permissions = [
    ...
    { name: 'meal-plan:create', resource: 'meal-plan', action: 'create' },
    { name: 'meal-plan:read', resource: 'meal-plan', action: 'read' },
    { name: 'meal-plan:delete', resource: 'meal-plan', action: 'delete' },
  ];
